...
main.o : main.c H264ParseSPS.h log.h
	gcc -c main.c H264ParseSPS.h H264ParseCommon.c log.h

H264ParseSPS.o : H264ParseSPS.c H264ParseSPS.h log.h
	gcc -c H264ParseSPS.c H264ParseSPS.h log.h
